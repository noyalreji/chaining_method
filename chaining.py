...
user1.make_deposit (1300).make_deposit (1200).make_deposit (1300).make_withdrawal (2200)
user1.display_user_balance()

# Have the first user make 3 deposits and 1 withdrawal and then display their balance
user2.make_deposit (1300).make_deposit (1200).make_withdrawal (200).make_withdrawal (200)
user2.display_user_balance()

# Have the third user make 1 deposits and 3 withdrawals and then display their balance
user3.make_deposit (6200).make_withdrawal (1200).make_withdrawal (1200).make_withdrawal (1200)
